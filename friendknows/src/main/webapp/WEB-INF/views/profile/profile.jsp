...
<div class="row">
	<div class="small-5 columns">
		<div class="row">
			<div class="small-11 columns fk-padding-top fk-summary-border">
	...
	<div class="small-7 columns fk-padding-top end">
		<c:forEach items="${initiated}" var="bean" varStatus="index">
			<div class="row hide fk-details fk-padding-top" id="details-${bean.id}">
				<div class="row">
