						...
						<c:if test="${not empty view}">
							<c:forEach items="${view}" var="review">
								<div class="row fk-no-margin fk-padding-top"
									style="margin-top: 0.4rem !important; margin-bottom: 0.4rem !important; background-color: whitesmoke; border-top: 1px solid rgba(221, 219, 219, 1);; border-bottom: 2px solid rgba(221, 219, 219, 1);">
